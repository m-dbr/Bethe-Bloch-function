...
///////////////////////////
/// 1. Bining zmienic zeby bylo tak jak dla protonow i porownac slice 1 i slice 2 DyVsY
///////////////////////////
...
void FitSlices(Int_t runid=1234, Int_t nSlices=15, Int_t saveCalibParams=0)
{
  ...
  if(!gdEdx_pion){
    ...
    Float_t pmax = 50.0;
    // 5-30 GeV:
    //Double_t A = 0.0512889;
    //Double_t B = 1.21862e-08;
    Double_t A = 0.0500852;
    Double_t B = 6.80264e-09;
    // 30-50
    //Double_t A = 0.0518372;
    //Double_t B = 1.88665e-08;
...
TF1* GetQuintupleGaussFit(TH1D* h,Float_t p,const Double_t* params)
{
  ...
  //func->FixParameter(3,0);
  //func->SetParLimits(4,gdEdx_kaon->Eval(p)-dd,gdEdx_kaon->Eval(p)+dd);
  func->SetParLimits(4,gdEdx_kaon->Eval(p)-2*dd,gdEdx_kaon->Eval(p)+3*dd);
  ...
  func->SetParLimits(4,func->GetParameter(4)-2*dd,func->GetParameter(4)+3*dd);
